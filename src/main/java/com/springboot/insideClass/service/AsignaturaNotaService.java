...
public class AsignaturaNotaService {
    ...
    public List<NotasInfoRequest> obtenerInfoNotas( String personaRun, String docente_run, Long establecimiento, Long asignaturaId, String fecha) {
        List<NotasInfoRequest> listanotas =  new ArrayList<>();
        try{

            List<Object> listaObjetosNativos =   asignaturaNotaRepository.fn_Notas( personaRun,docente_run, establecimiento, asignaturaId, fecha);
            Object[] fila;
