...
IF EXISTS (
              ...
              CREATE FUNCTION [dbo].[fn_InfoDocente] (@establecimiento bigint, @persona_run varchar(100), @curso_id bigint) RETURNS TABLE AS RETURN(
                 select distinct p.persona_run,
                                 ...
                                 d.docente_id
                     from   t_docente d
                     inner join t_asignatura_docente  ad on ad.asignatura_doc_docente_id = d.docente_id
                     inner join t_docenteeca deca on ad.asignatura_doc_id = deca.docenteeca_asignatura_docente_id
                     inner join t_asignatura a on ad.asignatura_doc_asignatura_id = a.asignatura_id
                     inner join t_curso_establ ce on deca.docenteeca_curso_establ_id = ce.curso_establ_id
                     ...
                     inner join t_usuario u on p.persona_run = u.usuario_persona_run
                       ...
                       IF EXISTS (SELECT * FROM sysobjects WHERE name = 'fn_InfoMatricula')  DROP FUNCTION fn_InfoMatricula;
                                      ...
                                      Create FUNCTION [dbo].[fn_InfoMatricula]  (@establecimiento bigint, @persona_run varchar(100), @curso_id bigint, @vigencia bigint, @apoderado_run varchar(20))
                                       ...
                                       inner join t_curso_matricula cm on cm.curso_matricula_id = m.matricula_id
                       				inner join t_curso_establ ce on cm.curso_establ_id = ce.curso_establ_id
